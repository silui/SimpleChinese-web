...
In order to use our quiz and study feature, user needs to login in first.
...
In quiz page, it will display the set score and whether you've completed the quiz. Once you selected a set, each set has less than or equal to 25 vocabs. Once you finish the, a result window will be displayed and shows you what you got wrong as well as the result. 
